...
- **Tools**: Python (OSMNX, NetworkX, Geopandas, Folium, Shapely, Scikit-learn; Geospatial preprocessing, Multi-centrality analysis, Spatial accessibility modeling, Interactive mapping)
